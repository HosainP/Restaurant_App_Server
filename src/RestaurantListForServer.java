...
public class RestaurantListForServer {
...
//        System.out.println("foods list: " + Arrays.toString(fileNames)); // it's good.
        for (String name : fileNames) {
            ...
            restaurant.foods.add(new Food(Integer.parseInt(parts[0].trim()), parts[1].trim(), parts[2].trim(), Integer.parseInt(parts[3].trim()), Integer.parseInt(parts[4].trim()), parts[5].trim()));
        }
//        System.out.println("food list is set: " + restaurant.foods);
    ...
    static void setComments(String theAddress, Restaurant restaurant) {
        ...
        for (String name : fileNames) {
            ...
            restaurant.comments.add(new Comment(parts[0].trim(), parts[1].trim(), Integer.parseInt(parts[2].trim())));
        }
