...
//        System.out.println("foods list: " + Arrays.toString(fileNames)); // it's good.
        for (String name : fileNames) {
            ...
            this.restaurant.foods.add(new Food(Integer.parseInt(parts[0].trim()), parts[1].trim(), parts[2].trim(), Integer.parseInt(parts[3].trim()), Integer.parseInt(parts[4].trim()), parts[5].trim()));
        }
    ...
    void setComments(String theAddress) {
        ...
        for (String name : fileNames) {
            ...
            this.restaurant.comments.add(new Comment(parts[0].trim(), parts[1].trim(), Integer.parseInt(parts[2].trim())));
        }
        System.out.println("comment list is set: " + this.restaurant.comments);
    }
